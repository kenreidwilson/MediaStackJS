...
export default abstract class BaseRepository<TEntity, TSearchQuery = SearchQuery, TUpdateRequest = TEntity> implements IRepository<TEntity, TSearchQuery, TUpdateRequest> {
    API: IRestAPI;
